...
import { ArrowLeft, Check, Download, Palette, Plus, ShieldCheck, Trash2, UserRound } from 'lucide-react';
...
export function UserSettingsPage() {
    ...
    const [tab, setTab] = useState<'profile' | 'appearance' | 'password' | 'data'>('profile');
    ...
    async function handleExportData() {
        ...
        try {
            ...
            setExportError(err instanceof Error ? err.message : 'Unable to export data');
        } finally {
            setExporting(false);
        }
    }
    function switchTab(value: 'profile' | 'appearance' | 'password' | 'data') { setTab(value); setError(''); setExportError(''); }
