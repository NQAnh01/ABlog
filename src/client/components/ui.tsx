...
export function Header({
  ...
  const isEditorPage =
    ...
    /^\/admin\/posts\/[^/]+\/edit$/.test(location.pathname);
  ...
  const openSearch = () => {
    setMobileOpen(false);
    window.dispatchEvent(new CustomEvent("lumina:open-command-palette"));
  };
  ...
  return (
    <>
      <header className="site-header">
        <div className="nav-shell">
          ...
          <nav className="desktop-nav">
            ...
            {!user && (
              <NavLink to="/register">{t("nav.signUp", "Sign Up")}</NavLink>
            )}
          </nav>
          <div className="nav-actions">
            ...
            <div className="account-menu" ref={accountRef}>
              {user ? (
                  ...
                  {accountOpen && (
                    <div className="account-popup" role="menu">
                      <div className="account-popup-profile">
                        ...
                        <div>
                          <strong title={user.name}>{displayName}</strong>
                ...
                <Link className="account-trigger" to="/login">
      ...
      <div
        className={`mobile-nav-layer${mobileOpen ? " open" : ""}`}
            ...
            <div>
              {user ? (
                ...
                <>
                  <span className="logo-mark">L</span>
                  <span>
                    <strong>Explore Lumina</strong>
                    <small>Stories worth your time</small>
                  </span>
                </>
              )}
            </div>
...
export function Footer() {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    if (!newsletterEmail.trim() || !newsletterEmail.includes("@")) {
      toast(t("footer.invalidEmail", "Please enter a valid email address"));
      return;
    }
    setNewsletterSubscribed(true);
    toast(t("footer.thanks", "Thank you for subscribing to Lumina Dispatch!"));
    setNewsletterEmail("");
  };
      ...
      <div className="container footer-content">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <nav className="footer-nav-list">
              <Link to="/blog">{t("footer.explore", "Explore Stories")}</Link>
              <Link to="/discussions">
          ...
          <div className="footer-col footer-newsletter">
            ...
            <p className="footer-newsletter-text">
              {t(
                "footer.dispatch",
                "Hand-curated essays, creative ideas, and commentary delivered weekly.",
              )}
            </p>
            {newsletterSubscribed ? (
              <div className="footer-newsletter-success" role="status">
                <span>
                  {t("footer.subscribed", "✓ Subscribed to dispatch")}
                </span>
              </div>
            ) : (
              <form
            ...
            <small className="footer-newsletter-note">
              {t("footer.note", "Curated editions every Sunday. No spam.")}
            </small>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p>
            {t(
              "footer.rights",
              "© 2026 Lumina Publishing Group. All rights reserved.",
            )}
          </p>
          <div className="footer-bottom-actions">
            {canInstall && (
              ...
              >
                ...
                {t("footer.install", "Install app")}
              </button>
            )}
            <span className="footer-badge">
              {t("footer.operational", "● Systems Operational")}
            </span>
          </div>
        </div>
      </div>
...
export function Layout({
  ...
  return (
    <div
      className={dark ? "theme-dark app-shell" : "theme-light app-shell"}
      data-accent={accent}
    >
...
export function EmptyState({ title, text }: { title?: string; text?: string }) {
  ...
  return (
    <div className="state">
      <h2>{title ?? t("common.empty", "Nothing here yet")}</h2>
      <p>{text ?? t("common.emptyText", "New stories will appear here.")}</p>
    </div>
  );
}
...
export function Pagination({
  ...
  return (
    <nav className="pagination" aria-label="Pagination">
      ...
      <span>{t("common.page", "Page {page} of {pages}", { page, pages })}</span>
      <button
        type="button"
        disabled={page >= pages}
        onClick={() => onPage(page + 1)}
