...
export function Header({ dark, onToggleTheme }: { dark: boolean; onToggleTheme: () => void }) {
  ...
  return <><header className="site-header"><div className="nav-shell"><Logo/><nav className="desktop-nav">
    ...
    {user && <NavLink to="/todos">Todos</NavLink>}
